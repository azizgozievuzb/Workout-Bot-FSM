...
/* Э.6 — подача каналов: «одна фраза на канал, в месте канала». Тексты игрока
   ...
   Смоук 30.08: пояснительный абзац под заголовком убран — «Полка наставника»
   понятно само, а лишний текст работал против минимализма.
   Там же: «подарок» — неверное слово, лот стоит капель. */
const EMPTY_SHELF_SLOT_TEXT = 'Здесь появится лот от наставника';
