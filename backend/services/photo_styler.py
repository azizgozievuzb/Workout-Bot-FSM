...
_CARD_PROMPT_WEAK = (
    ...
    "1b. PRESERVE THE FACIAL EXPRESSION EXACTLY as photographed: mouth shape and lip position "
    "(open, closed, surprised, neutral), whether teeth show, eyebrow position, eye openness and "
    "gaze direction. Do NOT add or remove a smile, do NOT purse, round or pout the lips, do NOT "
    "'fix' or soften the expression. The mood of the shot is part of the likeness.\n"
    ...
    "two thirds of the frame height, face centred. Keep the gaze exactly as photographed — "
    "reframing must not become a licence to redraw the face. If the source is a wider shot, "
    "crop into it; never extend the body or invent clothing.\n"
...
_CARD_PROMPT_DEEP = (
    ...
    "1b. KEEP THE FACIAL EXPRESSION of the source: mouth shape and lip position, whether teeth "
    "show, eyebrow position, eye openness and gaze. Do NOT add or remove a smile and do NOT purse "
    "or pout the lips — only the rendering style changes, never the expression.\n"
